...
class AuditLogService:
    ...
    def get_ticket_audit_logs(self, ticket_id: str, company_id: str):
        try:
            ...
            raise AuditLogAccessError(500, f"Database error while fetching ticket: {str(e)}")
        ...
        try:
            ...
            raise AuditLogAccessError(500, f"Database error while fetching audit logs: {str(e)}")
