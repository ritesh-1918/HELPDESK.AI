...
def test_main_uses_package_safe_imports_for_local_modules():
    ...
    assert "backend.config" in import_from_modules
    assert "backend.csrf" in import_from_modules
    assert "backend.swagger_config" in import_from_modules
    assert "backend.routers" in import_from_modules
    assert "backend.routes" in import_from_modules
