...
# Ensure project root and backend dir are on path for imports
sys.path.insert(0, os.path.abspath(os.path.dirname(__file__)))
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))

try:
    from backend.services.ensemble_classifier import EnsembleClassifier as ClassifierService
except Exception:
    try:
        from services.ensemble_classifier import EnsembleClassifier as ClassifierService
    except Exception:
        class DummyClassifierService:
            ...
            def predict(self, text):
                return None
        ClassifierService = DummyClassifierService
...
try:
    ...
    try:
        ...
        DuplicateService = DummyDuplicateService
...
try:
    ...
    try:
        ...
        class DummyRagService:
            ...
            def is_available(self):
                return False
            def search_knowledge_base(self, text, threshold=0.85):
                return None
        RagService = DummyRagService
