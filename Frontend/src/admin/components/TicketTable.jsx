  ...
  if (displayTickets.length === 0)
    return (
      <div
        ...
        style={{ border: '2px dashed #e5e7eb', borderRadius: '16px', margin: '16px' }}
      >
        <div
          style={{
            width: 64,
      ...
      <table className='w-full border-collapse'>
        <thead>
          <tr style={{ background: '#f8faf9', borderBottom: '1px solid #f0fdf4' }}>
            {['Ticket ID', 'Ticket Info', 'Category', 'Priority', 'Assigned Team', 'Status'].map(
              (h, i) => (
                <th
                  key={i}
                  style={{
        ...
        <tbody>
          {displayTickets.map((ticket) => {
            ...
            const effectiveSubcategory =
              ticket.correction?.corrected_subcategory || ticket.subcategory;
                ...
                <td style={{ padding: '14px 24px' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                    ...
                    >
                      ...
                      {formatTimelineDate(
                        ticket.created_at || ticket.createdAt || ticket.timestamp
                      )}
                    </span>
                  </div>
                </td>
                    ...
                    >
                      <span
                        style={{
                          ...
                          height: 4,
                          borderRadius: '50%',
                          background: categoryDotColors[effectiveCategory] || '#6b7280',
                  ...
                  >
                    <span
                      style={{
                        ...
                        opacity: ticket.status?.includes('Resolv') ? 0.4 : 1,
                      }}
                    ></span>
