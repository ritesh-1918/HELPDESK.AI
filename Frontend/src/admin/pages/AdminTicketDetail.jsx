...
const AdminTicketDetail = () => {
  ...
  const handleUpdate = async (updates, actionType) => {
    ...
    try {
      const { error: upError } = await supabase.from('tickets').update(updates).eq('id', ticket_id);
  ...
  if (isLoading)
    return (
      <div className='flex flex-col items-center justify-center min-h-[400px]'>
        ...
        <p className='text-gray-400 font-black uppercase tracking-[0.2em] italic'>
  ...
  return (
    <div
      ...
      className='-m-6 p-6 md:-m-10 md:p-10 space-y-6 animate-in fade-in duration-700'
    >
      {/* Header */}
      <div
        style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '4px' }}>
              <span
                style={{
                  ...
                  fontWeight: 700,
                  textTransform: 'uppercase',
                  color: displayStatus?.includes('progress')
                    ? '#2563eb'
                    : displayStatus?.includes('resolv')
                      ? '#16a34a'
                      : '#d97706',
                  background: displayStatus?.includes('progress')
                    ? '#dbeafe'
                    : displayStatus?.includes('resolv')
                      ? '#dcfce7'
                      : '#fef3c7',
            ...
            <>
              {ticket.status?.toLowerCase() !== 'in progress' && (
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    boxShadow: '0 4px 12px rgba(34,160,69,0.3)',
                    display: 'flex',
                    alignItems: 'center',
                    gap: '8px',
                    textTransform: 'uppercase',
              ...
              >
                {isUpdating === 'reassign' ? (
                  ...
                  <MoveRight size={14} color='#374151' />
                )}
                Divert
              </button>
              <button
        ...
        <div className='lg:col-span-8 space-y-8'>
          ...
          >
            ...
            <div style={{ padding: '28px' }}>
              <div
                style={{
                  background: 'linear-gradient(135deg, #0f1f12, #1a3320)',
                  color: '#ffffff',
                  borderRadius: '16px',
                  padding: '24px 28px',
                  fontSize: '15px',
        ...
        <div className='lg:col-span-4 space-y-8'>
          ...
          >
            ...
            <div style={{ padding: '24px' }} className='space-y-6'>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  >
                    ...
                    <span
                      style={{
                        background:
                          ticket.category?.toLowerCase() === 'hardware'
                            ? '#fff7ed'
                            : ticket.category?.toLowerCase() === 'network'
                              ? '#eff6ff'
                              : ticket.category?.toLowerCase() === 'access'
                                ? '#f5f3ff'
                                : ticket.category?.toLowerCase() === 'software'
                                  ? '#f0fdf4'
                                  : '#f8fafc',
                        color:
                          ticket.category?.toLowerCase() === 'hardware'
              ...
              <div
                style={{ borderTop: '1px solid #f0fdf4', paddingTop: '20px' }}
                className='space-y-3'
              >
                <label
                  style={{
          ...
          <Card className='w-full max-w-sm bg-white rounded-[2rem] border-none shadow-2xl p-8 space-y-6'>
            <div className='space-y-2'>
              ...
              <p style={{ fontSize: '12px', color: '#6b7280' }}>
                Reassign incident to a specialized unit.
              </p>
            </div>
            <div className='space-y-4'>
              <div className='space-y-2'>
                ...
                <Select
                  ...
                  buttonClassName='w-full bg-slate-50 border-2 border-transparent focus:border-emerald-500 rounded-xl px-4 py-3 text-xs font-bold transition-all outline-none'
                  options={[
        ...
        <div className='fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[100] flex items-center justify-center p-6 text-slate-900'>
          <Card className='w-full max-w-sm bg-white rounded-[2rem] border-none shadow-2xl p-8 space-y-6 text-black'>
            <div className='space-y-2'>
              ...
              <p style={{ fontSize: '12px', color: '#6b7280' }}>
                Manually correct AI classification labels.
              </p>
            </div>
            <div className='space-y-4'>
              <div>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setCorrectionForm({ ...correctionForm, category: e.target.value })
                  }
                  buttonClassName='w-full bg-slate-50 border-2 border-transparent focus:border-emerald-500 rounded-xl px-4 py-3 text-xs font-bold transition-all outline-none'
                  options={[
              ...
              <div>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setCorrectionForm({ ...correctionForm, priority: e.target.value })
                  }
                  buttonClassName='w-full bg-slate-50 border-2 border-transparent focus:border-emerald-500 rounded-xl px-4 py-3 text-xs font-bold transition-all outline-none'
                  options={[
