...
const AdminProfile = () => {
  ...
  return (
    <div
      style={{ background: '#f8faf9', minHeight: '100vh', paddingBottom: '60px' }}
      className='max-w-6xl mx-auto py-6 space-y-10 -m-6 p-6 md:-m-10 md:p-10 animate-in fade-in duration-700'
    >
      {/* 1. Profile Hero */}
      <div
        style={cs.card}
        className='flex flex-col md:flex-row items-center md:items-start gap-10 relative overflow-hidden'
      >
        <div className='relative group shrink-0'>
          <div
            style={{
              ...
              boxShadow: '0 0 0 6px rgba(34,160,69,0.08)',
              overflow: 'hidden',
              display: 'flex',
              alignItems: 'center',
              ...
              {!isEditingProfile ? (
                ...
                <div className='space-y-4 max-w-sm mx-auto md:mx-0'>
                  <input
                    ...
                    className='w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-lg font-bold focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all outline-none'
                  ...
                  <input
                    ...
                    className='w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all outline-none'
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    position: 'relative',
                    transition: 'all 0.4s',
                    background: isAdmin2FAEnabled ? '#22c55e' : '#d1d5db',
                    border: 'none',
                    cursor: 'pointer',
                    flexShrink: 0,
                  }}
                >
                  <div
                    style={{
                      ...
                      left: isAdmin2FAEnabled ? '26px' : '2px',
                    }}
                  ></div>
                </button>
              </div>
                ...
                <tbody>
                  {activityLog.map((log) => (
                    <tr key={log.id} className='hover:bg-[#f0fdf4] transition-colors'>
                      ...
                      <td style={{ padding: '16px 24px', fontSize: '11px', color: '#6b7280' }}>
                        {log.timestamp}
                      </td>
          ...
          >
            ...
            <div style={{ padding: '28px' }} className='space-y-5'>
              {[
                ...
                { label: 'Confirm Password', key: 'confirmPassword', ph: 'Confirm password' },
              ].map((f, i) => (
                <div key={i} className='space-y-1.5'>
                  ...
                  <input
                    type='password'
                    placeholder={f.ph}
                    className='w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all outline-none'
