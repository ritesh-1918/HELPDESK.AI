...
export default function Careers() {
  ...
  const jobs = [
    ...
    {
      title: 'AI Support Specialist (Tier 2 Override Ops)',
      location: 'Bengaluru',
      type: 'Full-Time',
      scale: '₹8L - ₹12L',
    },
      ...
      <div className='max-w-[800px] mx-auto px-4 md:px-6 mt-12 space-y-12'>
        <div className='space-y-4'>
          ...
          <p className='text-slate-600 text-base leading-relaxed'>
            Join our engineering-first team. We build self-healing pipelines, Tesseract OCR
            integrations, and dynamic telemetry mapping products.
          </p>
        </div>
        ...
        <div className='space-y-4'>
          {jobs.map((job, idx) => (
            <Card
              key={idx}
              className='p-6 rounded-[1.5rem] border border-slate-200/80 bg-white flex items-center justify-between shadow-sm flex-wrap gap-4 hover:border-emerald-300 transition-all cursor-pointer'
            >
