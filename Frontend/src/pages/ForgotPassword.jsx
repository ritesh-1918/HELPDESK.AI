...
function ForgotPassword() {
  ...
  return (
    <div
      className='min-h-screen flex items-center justify-center font-sans relative overflow-hidden p-6 py-12'
    ...
    >
      ...
      <div className='w-full max-w-md relative z-10'>
        ...
        <div className='flex justify-center mb-10'>
          <Link
            to='/'
            className='flex items-center gap-2 bg-white/40 backdrop-blur-xl px-5 py-2.5 rounded-2xl border border-white/40 shadow-xl shadow-emerald-900/5 transition hover:bg-white/60 group'
          >
            <BrainCircuit className='w-6 h-6 text-emerald-600 transition-transform group-hover:rotate-12' />
            <span
              className='font-extrabold text-xl tracking-tight text-[#0f1f12]'
              style={{ fontFamily: 'Syne' }}
            >
              HelpDesk<span className='text-emerald-600'>.ai</span>
            </span>
          </Link>
        </div>
        ...
        >
          ...
          <div className='text-center mb-10'>
            <h2
              className='text-3xl font-black text-[#0f1f12] tracking-tight'
              style={{ fontFamily: 'Syne' }}
            >
            ...
            <p className='text-gray-500 mt-2 font-medium'>
              {step === 1
                ? 'Enter your email to initiate recovery.'
                : step === 2
                  ? 'Enter the 6-digit code sent to your email.'
                  : 'Set a new high-security password.'}
            </p>
          </div>
                  ...
                  <form onSubmit={handleSendOtp} className='space-y-6'>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: '#fff',
                        boxShadow: '0 10px 30px rgba(34,160,69,0.2)',
                      }}
                ...
                {step === 2 && (
                  <form onSubmit={handleVerifyOtp} className='space-y-8'>
                    <div className='space-y-4'>
                      <label className='text-xs font-black uppercase tracking-widest text-gray-400 text-center block'>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: timerExpired ? '#9ca3af' : '#fff',
                        boxShadow: timerExpired ? 'none' : '0 10px 30px rgba(34,160,69,0.2)',
                      }}
                      onMouseEnter={(e) => {
                        if (!timerExpired) e.currentTarget.style.transform = 'translateY(-2px)';
                      }}
                      onMouseLeave={(e) => (e.currentTarget.style.transform = 'translateY(0)')}
                    >
                      {loading ? (
                  ...
                  <form onSubmit={handleUpdatePassword} className='space-y-6'>
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          Sync Credentials <KeyRound className='w-5 h-5' />
                        </>
                      )}
                    </button>
                  </form>
