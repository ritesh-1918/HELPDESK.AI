      ...
      <div className='min-h-screen bg-white flex items-center justify-center p-4'>
        ...
        >
          ...
          <p className='text-gray-600'>
            Thank you for your interest in HelpDesk.ai Enterprise. Our team will review your
        ...
        <div className='w-full lg:w-5/12 bg-emerald-950 p-10 md:p-16 flex flex-col justify-center relative overflow-hidden'>
          ...
          <div className='relative z-10 text-white'>
            ...
            <p className='text-emerald-100/70 text-lg mb-12'>
              Deploy fine-tuned AI categorization engines instantly. Eliminate helpdesk bottlenecks
              with our compliant, scalable infrastructure.
            </p>
              ...
              {[
                {
                  ...
                  desc: 'Train models on your proprietary internal docs.',
                },
                {
                  icon: Server,
                  title: 'On-Prem / Dedicated Infra',
                  desc: 'Keep data local with single-tenant architecture.',
                },
                {
                  icon: Zap,
                  title: 'SLA Management',
                  desc: 'Guaranteed 99.99% uptime with dedicated support.',
                },
              ].map((feature, i) => (
                <div key={i} className='flex gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-emerald-100/50 text-sm leading-relaxed max-w-xs'>
                      {feature.desc}
                    </p>
                  </div>
                </div>
          ...
          <div className='w-full max-w-xl mx-auto py-10'>
            <div className='mb-10 text-center lg:text-left'>
              ...
              <p className='text-gray-500 mt-2'>
                Fill out the form below and an Enterprise architect will be in touch shortly.
              </p>
            </div>
