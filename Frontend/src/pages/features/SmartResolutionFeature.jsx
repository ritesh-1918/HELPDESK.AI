...
const flowSteps = [
  {
    ...
    desc: 'User submits an issue via web form, email, or chat.',
    color: 'bg-blue-100 text-blue-600',
  },
  {
    icon: Database,
    title: 'Knowledge Check',
    desc: 'AI scans historical tickets for a matching resolved issue.',
    color: 'bg-purple-100 text-purple-600',
  },
  {
    icon: Bot,
    title: 'Auto-Resolve (if match found)',
    desc: 'Chatbot sends the proven solution and marks ticket resolved.',
    color: 'bg-emerald-100 text-emerald-600',
  },
  {
    icon: Users,
    title: 'Human Escalation (if no match)',
    desc: 'Routes to the correct team with full context pre-filled.',
    ...
    <div className='min-h-screen bg-white font-sans'>
      ...
      <section className='bg-gradient-to-br from-emerald-50 via-white to-teal-50 py-24 px-6 text-center'>
        <div className='max-w-4xl mx-auto'>
          ...
          <p className='text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed'>
            Our AI checks your historical ticket database. If it's seen this issue before — and
            knows the fix — it resolves it automatically, 24/7.
          </p>
          ...
          <div className='space-y-8'>
            {flowSteps.map(({ icon: Icon, title, desc, color }, i) => (
              <div key={i} className='flex gap-6 items-start'>
                <div
                  className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 relative z-10 ${color}`}
                >
      ...
      <section className='bg-emerald-950 py-24 px-6'>
        <div className='max-w-4xl mx-auto'>
          ...
          <p className='text-emerald-300/70 text-center mb-12'>
