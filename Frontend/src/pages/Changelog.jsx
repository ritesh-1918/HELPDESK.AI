        ...
        <div className='max-w-[1100px] mx-auto px-4 md:px-6 h-16 flex items-center justify-between'>
          <div className='flex items-center gap-3 cursor-pointer' onClick={() => navigate('/')}>
            ...
            <div className='flex items-baseline gap-2'>
              ...
              <span className='px-2 py-0.5 text-[10px] font-black bg-indigo-100 text-indigo-800 rounded-md uppercase tracking-wider'>
                Changelog
              </span>
            </div>
          </div>
      ...
      <div className='max-w-[800px] mx-auto px-4 md:px-6 mt-12 space-y-12'>
        <div className='space-y-4'>
          ...
          <p className='text-slate-600 text-base leading-relaxed'>
            Stay informed about system features, framework optimizations, and local AI training
            models introduced into HELPDESK.AI.
          </p>
        </div>
