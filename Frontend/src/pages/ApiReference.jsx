        ...
        <div className='max-w-[1100px] mx-auto px-4 md:px-6 h-16 flex items-center justify-between'>
          <div className='flex items-center gap-3 cursor-pointer' onClick={() => navigate('/')}>
            ...
            <div className='flex items-baseline gap-2'>
              ...
              <span className='px-2 py-0.5 text-[10px] font-black bg-blue-100 text-blue-800 rounded-md uppercase tracking-wider'>
                API
              </span>
            </div>
          </div>
      ...
      <div className='max-w-[900px] mx-auto px-4 md:px-6 mt-12 space-y-12'>
        <div className='space-y-4'>
          ...
          <p className='text-slate-600 text-base leading-relaxed'>
            Connect your existing CRM, Slack bots, or internal tools directly to the HELPDESK.AI
            triage engine. Classify incoming tickets and generate timelines instantly.
          </p>
        </div>
        ...
        <Card className='p-8 rounded-[2rem] border border-slate-200/80 bg-white space-y-6 shadow-sm'>
          ...
          <p className='text-slate-600 text-sm leading-relaxed'>
            All incoming API calls must contain a valid Bearer Token in the authorization header.
            Generate your API key inside the Admin Dashboard Settings panel.
          </p>
          <div className='bg-slate-950 p-4 rounded-xl font-mono text-xs text-slate-300 border border-slate-900 relative'>
            <span className='absolute top-2 right-2 text-[10px] uppercase font-bold text-slate-500'>
              Headers
            </span>
          ...
          <Card className='p-8 rounded-[2rem] border border-slate-200/80 bg-white space-y-6 shadow-sm'>
            <div className='flex items-center justify-between flex-wrap gap-2'>
              <div className='flex items-center gap-3'>
                ...
                <code className='text-sm font-extrabold text-slate-800'>
            ...
            <p className='text-slate-600 text-sm leading-relaxed'>
              Sends raw issue strings or base64 files for immediate NLP categorizing, priority
