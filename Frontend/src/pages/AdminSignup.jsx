...
function AdminSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (errMsg.toLowerCase().includes('failed to fetch')) {
        errMsg =
          "Network Error: Failed to fetch. This usually happens if your browser's ad-blocker (like Brave Shields, uBlock Origin, etc.) is blocking Supabase requests. Please try disabling your ad-blocker for this site and refresh!";
      }
      setError(errMsg);
    }
  };
      ...
      >
        ...
        >
          ...
          <p style={{ color: '#374151', fontSize: '15px', lineHeight: 1.7, marginBottom: '32px' }}>
            Registration request received! We've sent a verification link to{' '}
            <span style={{ fontWeight: 700, color: '#16a34a' }}>{formData.email}</span>.
          </p>
          <div
          ...
          >
            ...
            <ul className='space-y-3' style={{ fontSize: '14px', color: '#374151' }}>
              <li className='flex gap-2'>
                <span className='font-bold'>1.</span> Verify your email by clicking the link in our
                message.
              </li>
              <li className='flex gap-2'>
                <span className='font-bold'>2.</span> Your request will be reviewed by our Master
                Admin.
              </li>
              <li className='flex gap-2'>
                <span className='font-bold'>3.</span> You'll receive a final confirmation once
                approved.
              </li>
            </ul>
          </div>
  ...
  return (
    ...
    >
      ...
      <div
        className='hidden lg:flex w-5/12 items-center justify-center p-16 relative overflow-hidden'
      ...
      <div
        className='flex-1 overflow-y-auto px-4 py-8 lg:p-12 relative flex justify-center items-start lg:items-center'
        style={{ background: '#ffffff', borderLeft: '1px solid #f0fdf4' }}
      >
        <div
          className='w-full max-w-2xl bg-white rounded-[2rem] p-6 md:p-12 my-auto relative z-10'
          style={{ boxShadow: '0 4px 40px rgba(0,0,0,0.06)', border: '1px solid #f0fdf4' }}
        >
          {/* Progress Indicator */}
                ...
                >
                  <div className='mb-8'>
                    ...
                    <p className='text-gray-500 text-sm'>
                      Tell us who you are and create your admin account.
                    </p>
                  </div>
              ...
              {step === 2 && (
                ...
                >
                  <div className='mb-8'>
                    ...
                    <p className='text-gray-500 text-sm'>
                      Tell us about the organization you're registering.
                    </p>
                  </div>
              ...
              {step === 3 && (
                ...
                >
                  <div className='mb-8'>
                    ...
                    <p className='text-gray-500 text-sm'>
                      Review our policies and submit your application.
                    </p>
                  </div>
                  ...
                  <div className='bg-gray-50 border border-gray-100 rounded-2xl p-6 space-y-4'>
                    <label className='flex items-start gap-4 cursor-pointer group'>
                      ...
                      <span className='text-sm text-gray-600 leading-relaxed group-hover:text-gray-900 transition-colors'>
                        I agree to the{' '}
                        <Link to='/terms' className='text-emerald-700 font-bold hover:underline'>
                          Terms of Service
                        </Link>{' '}
                        and{' '}
                        <Link to='/privacy' className='text-emerald-700 font-bold hover:underline'>
                          Privacy Policy
                        </Link>
                    ...
                    <label className='flex items-start gap-4 cursor-pointer group pt-4 border-t border-gray-200/50'>
                      ...
                      <span className='text-sm text-gray-600 leading-relaxed group-hover:text-gray-900 transition-colors'>
                        ...
                        on the HelpDesk.ai platform as a primary administrator.
                      </span>
                    </label>
                  </div>
