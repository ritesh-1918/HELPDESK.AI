...
function Signup() {
    ...
    try {
      ...
      if (newUser) {
        ...
        if (updatedProfile?.status === 'pending_approval') {
          ...
          setSuccessMsg(
            `📧 Check your email! We sent a verification link to ${email}. After verifying your email, your request will be reviewed by your company admin.`
          );
        }
      }
    } catch (err) {
  ...
  if (successMsg) {
    return (
      ...
      >
        ...
        />
        <div
          className='w-full max-w-md bg-white rounded-3xl p-8 relative z-10 text-center'
  ...
  const inputFocus = (e) => {
    ...
    e.target.style.boxShadow = '0 0 0 3px rgba(34,160,69,0.1)';
  };
  const inputBlur = (e) => {
  ...
  return (
    <div
      className='min-h-screen flex items-center justify-center relative overflow-hidden p-6 py-12'
      style={{
        fontFamily: "'Inter', sans-serif",
        background: 'linear-gradient(160deg, #f0fdf4 0%, #dcfce7 60%, #bbf7d0 100%)',
      }}
            ...
            <div className='relative' ref={dropdownRef}>
              ...
              <div
                ...
                style={{
                  ...
                  borderColor: isDropdownOpen ? '#22c55e' : '#e5e7eb',
                  boxShadow: isDropdownOpen ? '0 0 0 3px rgba(34,160,69,0.1)' : 'none',
                }}
              >
                {selectedCompany ? (
              ...
              {isDropdownOpen && (
                <div
                  className='absolute z-50 top-full left-0 right-0 mt-2 bg-white overflow-hidden'
                  style={{
                    borderRadius: '12px',
                ...
                >
                  ...
                  <div className='max-h-60 overflow-y-auto p-1'>
                    {isLoadingCompanies ? (
                      ...
                      <div
                        className='px-4 py-6 text-center rounded-lg mx-1 my-1'
                        style={{
                          fontSize: '14px',
                          fontWeight: 500,
                          color: '#6b7280',
                      ...
                      >
                        ...
                        >
                          Ask your IT Admin to register your company first.
                        </span>
                      </div>
                    )}
                  </div>
