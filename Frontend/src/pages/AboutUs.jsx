      ...
      <div className='max-w-[800px] mx-auto px-4 md:px-6 mt-12 space-y-12'>
        <div className='space-y-4'>
          ...
          <p className='text-slate-600 text-base leading-relaxed'>
            At HELPDESK.AI, we strive to build local machine learning workflows that eliminate
            manual ticket tagging, priority guessing, and routing bottlenecks for modern Indian
            businesses.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <Card className='p-6 rounded-[2rem] border border-slate-200 bg-white space-y-3'>
            ...
            <p className='text-xs text-slate-500 leading-relaxed font-semibold'>
              By backing up offline sentence embeddings with fast Gemini failover pipelines, we
              achieve 100% platform availability under tight network margins.
            </p>
          </Card>
          ...
          <Card className='p-6 rounded-[2rem] border border-slate-200 bg-white space-y-3'>
            ...
            <p className='text-xs text-slate-500 leading-relaxed font-semibold'>
              All ticket summaries, OCR attachments, and database timelines remain securely locked
              under regional cloud networks.
            </p>
          </Card>
        </div>
      </div>
