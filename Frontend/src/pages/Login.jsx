    ...
    <div className='min-h-screen flex' style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        <div className='relative z-10 max-w-lg'>
          ...
          >
            Automate your <span style={{ color: '#16a34a' }}>IT Support</span>
          </h1>

          {/* Subtext */}
          <p style={{ color: '#374151', fontSize: '16px', lineHeight: 1.7, marginBottom: '32px' }}>
            Join thousands of IT teams using HelpDesk.ai to categorize, route, and resolve tickets
            instantly.
          </p>
          ...
          >
            <div className='flex gap-4 items-start'>
              ...
              <div>
                ...
                <p style={{ color: '#111827', fontWeight: 500, fontSize: '14px' }}>
        ...
        <div className='w-full max-w-md mt-8 lg:mt-0' style={{ padding: '32px' }}>
          ...
          {magicLinkSent ? (
            <div className='text-center py-6'>
              ...
              <h3
                style={{ fontSize: '20px', fontWeight: 700, color: '#0f1f12', marginBottom: '8px' }}
              >
                Check your email
              </h3>
