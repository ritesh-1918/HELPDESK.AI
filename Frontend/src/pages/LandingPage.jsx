    ...
    <div className='fixed inset-0 z-[999] flex items-center justify-center p-4'>
      ...
      >
        ...
        <div className='p-6 bg-gray-900 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4'>
          <div>
            <h2 className='text-xl font-extrabold text-white italic uppercase tracking-tight'>
              Full Platform Walkthrough
            </h2>
            <p className='text-gray-400 text-xs font-medium'>
              Experience the synergy of AI and human expertise.
            </p>
          </div>
...
export default function LandingPage() {
        ...
        <div className='space-y-4'>
          <div className='bg-white/5 border border-white/10 rounded-2xl p-4 max-w-[100%] float-left animate-in slide-in-from-left duration-500'>
            <p className='text-sm text-blue-200 italic font-medium'>
              "Hey support, the wifi in downstream lab 3 is acting up again. Can't connect. Need
              fixed ASAP!"
            </p>
          </div>
        </div>
      ...
      visual: (
        <div className='relative flex flex-col items-center justify-center h-full gap-4'>
          ...
          <div className='grid grid-cols-2 gap-2 w-full'>
            <div className='bg-emerald-500/10 border border-emerald-500/20 p-2 rounded text-[10px] text-emerald-300 font-bold uppercase tracking-widest text-center'>
              Category: Network
            </div>
            <div className='bg-emerald-500/10 border border-emerald-500/20 p-2 rounded text-[10px] text-emerald-300 font-bold uppercase tracking-widest text-center'>
              Priority: High
  ...
  return (
    <div className='min-h-screen bg-white font-sans text-slate-800'>
      ...
      {/* ==================== HOW IT WORKS ==================== */}
      <section
        className='bg-emerald-950 py-16 md:py-32 text-white relative overflow-hidden'
        id='how-it-works'
      >
                ...
                {steps.map((step, idx) => (
                  ...
                  >
                    <div className='flex items-start gap-4 md:gap-6'>
                      <div
                        className={`shrink-0 w-10 md:w-12 h-10 md:h-12 rounded-xl md:rounded-2xl flex items-center justify-center font-black text-lg md:text-xl italic transition-all duration-500 ${activeStep === idx ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/20 rotate-12 scale-110' : 'bg-white/10 text-white/40'}`}
                      >
                        {step.num}
                      </div>
                      <div>
                        <h3
                          className={`text-xl font-black italic uppercase transition-colors duration-500 ${activeStep === idx ? 'text-white' : 'text-white/60'}`}
                        >
                          {step.title}
                        </h3>
                        {activeStep === idx && (
              ...
              <div className='absolute inset-0 bg-gradient-to-br from-emerald-500/10 to-transparent rounded-[32px] md:rounded-[40px] border border-white/5 backdrop-blur-3xl overflow-hidden p-6 md:p-12 flex items-center justify-center'>
                <AnimatePresence mode='wait'>
                  ...
                  >
                    ...
                    <div className='w-full max-w-sm'>{steps[activeStep].visual}</div>
                  </motion.div>
                </AnimatePresence>
              </div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center border-b border-white/10'>
          ...
          <div className='mt-8'>
            ...
            >
              ...
              <span className='underline underline-offset-4 decoration-white/20'>Sign in</span>
            </button>
          </div>
        </div>
