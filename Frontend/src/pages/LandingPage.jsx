                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="flex flex-col md:flex-row gap-8 md:gap-16 md:items-center">
                        ...
                        <div className="w-full md:w-1/2">
                            <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 text-emerald-400 rounded-full  border border-emerald-500/20 mb-4 md:mb-6">
                                The Journeytext-xs font-semibold uppercase tracking-tight
                            </div>
                            ...
                            <div className="space-y-4">
                                {steps.map((step, idx) => (
                                    <div
                                        ...
                                        className={`group cursor-pointer p-6 rounded-3xl transition-all duration-300 ease-outborder ${activeStep === idx
                                    ...
                                    >
                                        <div className="flex items-start gap-4 md:gap-6">
                                            <div className={`shrink-0 w-10 md:w-12 h-10 md:h-12 rounded-xl md:rounded-2xl flex items-center justify-center font-extrabold text-lg md:text-xl  transition-all duration-300 ease-out${activeStep === idx ? 'bg-emerald-500 text-white shadow-lg shadow-emerald-500/20 rotate-12 scale-110' : 'bg-white/10 text-white/40'}`}>
                                                {step.num}
                                            </div>
                                            <div>
