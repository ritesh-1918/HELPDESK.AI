          ...
          <div className='bg-amber-50 border border-amber-100 rounded-2xl p-6 mb-6 flex items-center gap-4 shadow-sm animate-in fade-in slide-in-from-top-4'>
            ...
            <div>
              ...
              <p className='text-amber-700 font-medium'>
                Sent back to our support team. We'll respond shortly.
              </p>
            </div>
          </div>
        )}
            ...
            <Card className='p-0 overflow-hidden border-none shadow-xl shadow-gray-200/50'>
              ...
              <CardContent className='p-8 space-y-6'>
                <div>
                  ...
                  <p className='text-xl md:text-2xl font-mono font-black text-emerald-900 tracking-wider'>
                    #{ticket.ticket_id}
                  </p>
                </div>
                <div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <div className='p-4 bg-gray-50 rounded-xl border border-gray-100'>
                    ...
                    <div
                      className={`flex items-center gap-2 font-black uppercase text-xs tracking-tight ${isResolved ? 'text-emerald-600' : 'text-amber-600'}`}
                    >
                      <div
                        className={`w-2 h-2 rounded-full ${isResolved ? 'bg-emerald-600' : 'bg-amber-500 animate-pulse'}`}
                      ></div>
                      {ticket.status}
                    </div>
                  </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            <p
                              className={`text-[10px] font-medium text-gray-400 px-1 ${isUser ? 'text-right' : 'text-left'}`}
                            >
                ...
                <div className='space-y-12'>
                  ...
                  {isResolved && (
                    <div className='flex items-start gap-6 relative animate-in fade-in duration-500'>
                      ...
                      <div>
                        <p className='font-black text-sm text-emerald-900 uppercase tracking-tight'>
                          Resolved
                        </p>
