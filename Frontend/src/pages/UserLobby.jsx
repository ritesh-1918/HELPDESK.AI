        ...
        {isTransitioning ? (
          ...
          <div className='py-4'>
            ...
            <p className='text-gray-500 text-sm mb-8'>
              Unfortunately, your request to join your company has been declined by an
              administrator.
            </p>
            <button
              onClick={handleLogout}
              className='px-6 py-2 bg-white border border-gray-200 shadow-sm rounded-xl text-gray-700 text-sm hover:bg-gray-50 font-medium transition'
            >
              Return to Login
            </button>
          </div>
          ...
          <>
            ...
            <p className='text-gray-500 text-sm mb-8 leading-relaxed'>
              {isRiteshPrivateLtd ? (
                <>
                  You are now waiting for approval from the{' '}
                  <span className='font-bold text-slate-800'>Ritesh Private Limited</span> admin.
                </>
              ) : (
                <>
