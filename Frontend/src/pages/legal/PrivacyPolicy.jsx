    ...
    <div className='min-h-screen bg-gray-50 font-sans'>
      ...
      <div className='max-w-4xl mx-auto px-6 py-16'>
        ...
        <div className='bg-blue-50 border border-blue-100 rounded-2xl p-5 mb-12 text-sm text-blue-800'>
          Your privacy matters to us. This policy explains how HelpDesk.ai collects, uses, and
          protects your personal data. We comply with the Digital Personal Data Protection Act
          (DPDP) 2023 of India and maintain GDPR-equivalent standards.
        </div>
