    ...
    <div className='min-h-screen bg-[#f6f8f7] pb-20'>
        ...
        <div className='max-w-[1100px] mx-auto px-4 md:px-6 h-16 flex items-center justify-between'>
          <div className='flex items-center gap-3 cursor-pointer' onClick={() => navigate('/')}>
            ...
            <div className='flex items-baseline gap-2'>
              ...
              <span className='px-2 py-0.5 text-[10px] font-black bg-slate-100 text-slate-800 rounded-md uppercase tracking-wider'>
                Legal
              </span>
            </div>
          </div>
      ...
      <div className='max-w-[800px] mx-auto px-4 md:px-6 mt-12 space-y-8'>
        ...
        <Card className='p-8 rounded-[2rem] border border-slate-200 bg-white space-y-6 shadow-sm text-sm text-slate-600 leading-relaxed font-medium'>
          ...
          <p>
            HELPDESK.AI uses secure, essential first-party cookies to manage active user sessions,
            retain user preferences, and authenticate client tokens accessing our Supabase data
            gateway.
          </p>
          ...
          <p>
            We do not run external tracking scripts or advertising scripts. Stripe cookies are
            injected solely during active checkouts to maintain secure payment processing integrity.
          </p>
          ...
          <p>
            You can clean, block, or disable active cookies via your browser's security panel
