    ...
    <div className='min-h-screen bg-gray-50 font-sans'>
      ...
      <div className='max-w-4xl mx-auto px-6 py-16'>
        ...
        <div className='bg-emerald-50 border border-emerald-100 rounded-2xl p-5 mb-12 text-sm text-emerald-800'>
          Please read these Terms of Service carefully before using HelpDesk.ai. By registering or
          using our platform, you confirm that you have read, understood, and agree to be bound by
          these terms.
        </div>
