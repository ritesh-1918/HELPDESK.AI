...
import { 
    ...
    Search, Copy, Check, Terminal, ExternalLink, ArrowRight, ChevronRight
} from 'lucide-react';
...
const DocsPortal = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f6f8f7] pt-24 pb-20">
            <div className="max-w-[1100px] mx-auto px-4 md:px-6 flex flex-col gap-8">
