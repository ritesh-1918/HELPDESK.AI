  ...
  return (
    ...
    >
      <div className='flex justify-between items-start gap-4'>
        <h4 className='font-bold text-gray-900 text-lg leading-snug group-hover:text-emerald-700 transition-colors'>
          {faq.q}
        </h4>
    ...
    const fetchVideos = async () => {
      ...
      try {
        ...
        const fallbackList =
          activeTab === 'All'
            ? YOUTUBE_RESOURCES
            : YOUTUBE_RESOURCES.filter((v) => v.category === activeTab);
      ...
      <div className='bg-emerald-900 border-b border-emerald-950/20 relative overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-6 py-16 lg:py-24 relative z-10 flex flex-col items-center text-center'>
          ...
          <p className='text-lg text-emerald-100 max-w-2xl mx-auto font-medium opacity-90 mb-10'>
            Search our **Solution Library**, watch curated IT tutorials, or connect with a support
            agent instantly.
          </p>
          ...
          <div className='lg:col-span-1 space-y-6'>
            <div className='bg-gradient-to-b from-gray-900 to-gray-800 rounded-3xl p-6 text-white shadow-xl relative overflow-hidden'>
              ...
              <div className='space-y-3'>
                <a
                  href={generateMailto()}
                  className='w-full group flex items-center justify-between bg-white/10 hover:bg-white/20 border border-white/10 rounded-xl p-4 transition-all focus:outline-none focus:ring-2 focus:ring-white/50 cursor-pointer block'
                >
