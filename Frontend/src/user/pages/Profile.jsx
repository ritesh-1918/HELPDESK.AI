...
const Profile = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (rpcError) {
        console.warn(
          'RPC delete_user not found or failed. Attempting profile removal...',
          rpcError
        );
  ...
  const ticketsResolvedByAI = userTickets.filter(
    (t) =>
      t.status?.toLowerCase()?.includes('auto') || t.status?.toLowerCase()?.includes('resolved')
  ).length;
  const ticketsEscalated = userTickets.filter(
    (t) =>
                  ...
                  <div className='divide-y divide-slate-50'>
                        ...
                        <div className='w-full p-8 flex items-center justify-between hover:bg-red-50 transition-all group border-t border-slate-50'>
                          <div className='flex items-center gap-6'>
                            ...
                            <div className='text-left'>
                              ...
                              <p className='text-[10px] font-bold text-slate-400 uppercase tracking-widest'>
                                Advanced technical bug reporting
                              </p>
                            </div>
                          </div>
                          <ChevronRight
                            size={18}
                            className='text-slate-300 group-hover:text-red-600 transition-all'
                          />
                        </div>
                      }
                    />
                    ...
                    >
                      <div className='flex items-center gap-6'>
                        ...
                        <div className='text-left'>
                          <p className='text-sm font-black text-amber-600 uppercase italic tracking-tight'>
                            Terminate Session
                          </p>
                          <p className='text-[10px] font-bold text-amber-500 uppercase tracking-widest'>
                            Securely eject from neural network
                          </p>
                        </div>
                      </div>
                      <ChevronRight
                        size={18}
                        className='text-amber-200 group-hover:text-amber-500 transition-all'
                      />
                    </button>
                    ...
                    >
                      <div className='flex items-center gap-6'>
                        ...
                        <div className='text-left'>
                          <p className='text-sm font-black text-red-600 uppercase italic tracking-tight'>
                            Delete Account
                          </p>
                      ...
                      <ChevronRight
                        size={18}
                        className='text-red-200 group-hover:text-red-500 transition-all'
                      />
                    </button>
                  </div>
                </CardContent>
