...
const AIProcessing = () => {
    ...
    }, [text, image_text, image_base64, navigate, setAITicket, settings, user, profile, showToast, original_text, original_language, template_id, template_used, user_modified, ticket_title]);
