    ...
    return (
      <div className='flex-1 flex flex-col items-center justify-center p-10 mt-20'>
        ...
        <p className='text-gray-500 mt-2 text-center max-w-md'>
          We couldn't locate the ticket you're looking for. It may have been deleted or the ID is
          incorrect.
        </p>
        <button
        ...
        <div className='flex flex-col md:flex-row md:items-start justify-between gap-4'>
          <div className='flex-1'>
            ...
            <h1 className='text-3xl sm:text-4xl font-black text-gray-900 tracking-tight leading-[1.15] max-w-3xl'>
              {ticket.summary ||
                ticket.subject ||
                (ticket.text?.length > 120
                  ? ticket.text.substring(0, 120) + '...'
              ...
              {entities.length > 0 ? (
                <div className='flex flex-wrap gap-2'>
                  {entities.map((entity, i) => (
                    <span
                      key={i}
                      className='inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-semibold bg-white border border-gray-200 text-gray-700 shadow-sm'
                    >
            ...
            {ticket.image_url || ticket.image || ticket.capturedFileBase64 ? (
              ...
              >
                ...
                <div className='absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/10 transition-opacity'>
                  <span className='bg-white/90 text-gray-800 text-xs font-bold px-3 py-1.5 rounded-lg shadow-sm'>
              ...
              {isAutoResolved ? (
                  ...
                  <div className='space-y-3'>
                    {solutionSteps.length > 0 ? (
                      ...
                      <p className='text-sm text-gray-600'>
                        The AI provided an automated resolution to this issue.
                      </p>
                    )}
                  </div>
                ...
                <div className='flex flex-col gap-4'>
                  <div className='flex gap-3 text-sm'>
                    ...
                    <p className='text-gray-700 font-medium leading-relaxed'>
                      This ticket was resolved by human support from the{' '}
                ...
                <div className='flex flex-col'>
                  <div className='flex gap-3 text-sm'>
                    ...
                    <p className='text-gray-700 font-medium leading-relaxed'>
                      This ticket has been escalated to human support. The{' '}
                      <span className='font-bold text-gray-900'>
                        {ticket.assigned_team || 'Support'}
                      </span>{' '}
