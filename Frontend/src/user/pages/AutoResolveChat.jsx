            ...
            <AnimatePresence>
              {messages.map((msg, idx) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-full shrink-0 flex items-center justify-center shadow-sm mt-1 
                    ...
                    <div className='flex flex-col gap-1.5'>
                      <div
                        className={`p-6 rounded-[1.75rem] text-sm font-semibold leading-relaxed shadow-sm transition-all
                                                ${
                                                  msg.role === 'bot'
                        ...
                        {msg.role === 'bot' ? (
                          <ReactMarkdown
                            ...
                            components={{
                              ...
                              ol: ({ ...props }) => (
                                <ol className='list-decimal ml-4 space-y-2 mb-3' {...props} />
                              ),
                              li: ({ ...props }) => <li className='mb-1' {...props} />,
                              h1: ({ ...props }) => (
                                <h1
                                  className='text-lg font-black mb-3 mt-3 text-slate-900 tracking-tight'
                                  {...props}
                                />
                              ),
                              h2: ({ ...props }) => (
                                <h2
                                  className='text-base font-black mb-3 mt-2 uppercase tracking-widest text-slate-800 text-[10px]'
                                  {...props}
                                />
                              ),
                              ...
                              code: ({ inline, ...props }) =>
                                inline ? (
                                  <code
                                    className='bg-emerald-50 px-1.5 py-0.5 rounded font-mono text-[12px] font-bold text-emerald-600'
                                    {...props}
                                  />
                                ) : (
                                  <code
                                    className='block bg-slate-900 text-slate-100 p-5 rounded-2xl font-mono text-[12px] mb-4 border border-slate-800 shadow-xl overflow-x-auto'
                                    {...props}
                                  />
                                ),
                              strong: ({ ...props }) => (
                      ...
                      <span
                        className={`text-[9px] font-black text-slate-400 uppercase tracking-widest ${msg.role === 'user' ? 'text-right' : 'text-left'}`}
                      >
                        {msg.timestamp}
                      </span>
                    </div>
