...
const steps = [
  {
    ...
    content:
      'This is your personal support hub. From here you can track all your tickets and access AI-powered help.',
    placement: 'bottom',
    disableBeacon: true,
  },
  {
    ...
    content:
      'Click here to submit a new support ticket. Our AI will triage it instantly—most issues are resolved in minutes.',
    placement: 'bottom',
    disableBeacon: true,
  },
  {
    ...
    title: 'Quick Actions',
    content:
      'Jump straight to the most common issue types. Each tile routes your problem to the right team automatically.',
    placement: 'top',
    disableBeacon: true,
  },
  {
    ...
    content:
      'Keep tabs on all your open and resolved tickets in real-time. Click any row to view the full conversation thread.',
    placement: 'top',
    disableBeacon: true,
  },
];
...
function EmeraldTooltip({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className='text-base font-black text-gray-900 mb-2 leading-tight'>{step.title}</h3>

      {/* Body */}
      <p className='text-sm text-gray-500 font-medium leading-relaxed mb-5'>{step.content}</p>
