...
const TicketTimeline = ({ ticketId, ticket: passedTicket, className = '', forceStep }) => {
  ...
  return (
    <div
      className={`bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden ${className}`}
    >
      {/* ════════════════════════════════════
                TICKET SUMMARY CARD
            ════════════════════════════════════ */}
      <div className='px-6 pt-6 pb-5 border-b border-gray-50'>
        ...
        <div className='grid grid-cols-2 gap-3'>
          ...
          />
          <SummaryField Icon={FolderOpen} label='Category' value={ticket.category || '—'} />
          <SummaryField Icon={Users} label='Assigned Team' value={ticket.assigned_team || '—'} />
        </div>
      </div>
                  ...
                  <div className='flex items-center gap-1 mt-2'>
                    ...
                    <span
                      className={`text-[10px] font-semibold tracking-wide ${
                        state === 'active' ? 'text-emerald-500' : 'text-gray-300'
                      }`}
                    >
                      {ts}
                    </span>
