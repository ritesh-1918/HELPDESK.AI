...
const NotificationPopover = ({ isAdmin = false }) => {
  ...
  return (
    ...
    >
      ...
      <PopoverContent
        align='end'
        className='w-80 p-0 shadow-2xl border-gray-100 rounded-2xl overflow-hidden mt-1 z-50'
      >
              ...
              {myNotifications.map((notif) => (
                ...
                >
                  ...
                  <div className='flex-1 min-w-0'>
                    <p
                      className={`text-xs ${!notif.read ? 'font-bold text-gray-900' : 'font-medium text-gray-600'}`}
                    >
                      {notif.title}
                    </p>
