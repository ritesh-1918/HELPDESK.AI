...
export const api = {
  ...
  assessOCR: async (imageBase64) => {
    try {
      const response = await axios.post(`${API_BASE_URL}/ai/ocr/assess`, { image_base64: imageBase64 }, { timeout: 30000 });
      return response.data;
    } catch (error) {
      console.warn("[OCR] Quality assessment failed:", error);
      return null;
    }
  }
};
