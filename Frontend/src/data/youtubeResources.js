export const YOUTUBE_RESOURCES = [
  {
    ...
    description:
      'Step-by-step guide to resolving the most common wireless networking problems on Windows machines.',
    category: 'Network',
  ...
  },
  {
    ...
    description:
      'Optimize performance and close background processes slowing down your workstation.',
    category: 'Hardware',
