  ...
  return (
    <div ref={containerRef} className={`relative ${className || 'flex-1'}`} {...props}>
      ...
      >
        ...
        <ChevronDown
          className={`w-4 h-4 ml-2 text-slate-400 shrink-0 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`}
        />
      </button>
