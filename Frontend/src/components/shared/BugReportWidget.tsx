                                ...
                                <div className="mb-6 bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3 text-sm text-blue-800">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-700/90 leading-relaxed">
                                            Page URL, browser info, console errors, and screen dimensions are automatically attached. You don't need to provide deep technical detailsΓÇöjust describe what you experienced.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        {!advanced && (
                                            <p className="text-xs text-slate-400 mt-1.5 ml-1">
                                                Describe what went wrong — we'll handle the rest.
                                            </p>
                                        )}
                                    </div>
