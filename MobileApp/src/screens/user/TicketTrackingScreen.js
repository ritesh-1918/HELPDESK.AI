    ...
    <View style={styles.stepContainer}>
      <View style={styles.leftColumn}>
        ...
        >
          <Icon
            size={20}
            color={isCompleted || isCurrent ? COLORS.white : COLORS.textMuted}
          />
        </View>
        {!isLast && (
          <View
      ...
      <View style={styles.stepContent}>
        <Text style={[styles.stepTitle, isCurrent && styles.currentTitle]}>
          {title}
        </Text>
    ...
    const steps = [
      {
        ...
        description:
          "Your request has been successfully received by the system.",
        icon: Clock,
        isCompleted: true,
      },
      {
      ...
      },
      {
        ...
        title: "Resolved",
        description:
          "The issue has been resolved. Please check the resolution details.",
        icon: ShieldCheck,
        isCompleted: ticket?.status === "resolved",
        isCurrent: false,
        isLast: true,
