    ...
    try {
      ...
      if (uploadError) {
        if (uploadError.message.includes("bucket not found")) {
          throw new Error(
            'Supabase Storage bucket "profile-pics" not found. Please create a public bucket named "profile-pics" in your Supabase dashboard.',
          );
        }
        throw uploadError;
      }
            ...
            <View style={styles.editForm}>
              ...
              <View style={styles.editField}>
                ...
                <TextInput
                  ...
                  onChangeText={(v) =>
                    setFormData({ ...formData, job_title: v })
                  }
