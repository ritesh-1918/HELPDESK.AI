      ...
      <SafeAreaView style={styles.loadingContainer}>
        ...
        <View style={styles.loadingHeader}>
          ...
          <Text style={styles.loadingSubtitle}>
            HelpDesk.ai is orchestrating your request
          </Text>
        </View>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Our neural engine has parsed your request. Please confirm the
            details below.
          </Text>
        </View>
        ...
        >
            ...
            <View style={[styles.resultItem, { flex: 1 }]}>
              ...
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      result.priority === "Critical" ? "#fee2e2" : "#fef3c7",
                  },
                ]}
              >
                <Clock
                  size={14}
                  color={
                    result.priority === "Critical" ? COLORS.error : "#f59e0b"
                  }
                />
                <Text
                  style={[
          ...
          {result.ocr_text ? (
            <View style={styles.resultItem}>
              ...
              <Text style={styles.ocrValue} numberOfLines={3}>
                {result.ocr_text}
              </Text>
            </View>
          ) : null}
