      ...
      <View style={styles.container}>
        ...
        <View style={styles.successWrap}>
          ...
          <Text style={styles.successMsg}>
            ...
            {"\n\n"}Once verified, a master admin will review and approve your
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              Set up your company and admin account for HelpDesk.ai
            </Text>
          </View>
          ...
          >
            ...
            <Text style={styles.disclaimer}>
              After submission, a master admin will review and approve your
              company registration. This may take up to 24 hours.
            </Text>
          </Animated.View>
        </ScrollView>
      </KeyboardAvoidingView>
