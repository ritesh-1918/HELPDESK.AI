...
class RateLimiter:
    """Per-IP token bucket rate limiter with IP whitelist support."""

    def __init__(self, max_requests: int = 10, window_seconds: int = 60, allowed_ips: set[str] | None = None):
    ...
    def is_allowed(self, identifier: str) -> tuple[bool, int]:
        ...
        """
        if identifier in self.allowed_ips:
            return True, 0
